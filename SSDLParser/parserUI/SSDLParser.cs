...
namespace parserUI
{
    class SDDLParser
    {
        ...
        private static string RemoveUnwantedCharacters(string input, char[] NotAllowedCharacters)
        {
            var filtered = input.ToCharArray()
                .Where(c => !NotAllowedCharacters.Contains(c))
                .ToArray();
        ...
        {
            trustee = RemoveUnwantedCharacters(trustee, "()\r\n".ToCharArray());
